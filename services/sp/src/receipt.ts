 ...
 * end of its settlement window. Because every payer's withdrawDelay >= the
 * window, a mandate enqueued at T is always settleable before funds requested
 * for withdrawal after T can leave the wallet.
 */
